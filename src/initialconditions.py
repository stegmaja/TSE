...
class InitialConditions:
    def __init__(self):
        ...
        if args.random:
            ...
            args.m1 = ot.power_law_sample(-2.3, args.m1_min, args.m1_max)
            args.m2 = np.random.uniform(args.m2_min, args.m1)
            args.m3 = np.random.uniform(args.m3_min, args.m1+args.m2)
