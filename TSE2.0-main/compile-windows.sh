...
f2py --compiler=mingw32 -c MOBSE/input/const_mobse.h MOBSE/input/zdata.h -m my_lib MOBSE/src/comenv.f MOBSE/src/corerd.f MOBSE/src/deltat.f MOBSE/src/dgcore.f MOBSE/src/evolve.f MOBSE/src/gntage.f \
