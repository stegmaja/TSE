...
def plot(t,y,m1,m2,m3,logr1,logr2,logr3,filename=str(ic.seed)+'_'+str(ic.Z).replace('.',''),title='Evolution of triple system'):
    ...
    # Ignore all warnings within that function
    # This is just because oftentimes we want to produce plots for certain parameters while others 
    # (e.g., BH parameters) are not yet implemented
