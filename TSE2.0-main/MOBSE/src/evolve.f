...
*
* 5) The value of lambda1 used in calculations of the envelope binding 
*    energy for giants in common-envelope is now variable (see function 
*    in zfuncs). The lambda1 function has been fitted by Onno to detailed 
...
*
      ...
      tb = tb*yeardy
      if(jp.ge.200.and.saveflag.eqv..true.)then
