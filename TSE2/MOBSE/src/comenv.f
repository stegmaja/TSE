...
*
      ...
      REAL*8 AURSUN,K3,ALPHA1,lambda1
      PARAMETER (AURSUN = 214.95D0,K3 = 0.21D0) 
      COMMON /VALUE2/ ALPHA1,lambda1
      LOGICAL COEL
...
*
      ...
      COEL = .FALSE.
*
* We do not know if there is a SNe during the CE phase
      SNexplosion = 0 
*
...
*
     ...
     &            R1,L1,KW1,MC1,RC1,MENV,RENV,K21)
      ...
      MENVD = MENV/(M1-MC1)
      RZAMS = RZAMSF(M01)
      LAMB1 = CELAMF(KW,M01,L1,R1,RZAMS,MENVD,lambda1)
      KW = KW2
...
*
* Calculate the binding energy of the giant envelope (multiplied by lambda1).
*
...
*
      ...
      IF(KW2.GE.2.AND.KW2.LE.9.AND.KW2.NE.7)THEN
         MENVD = MENV/(M2-MC2)
         RZAMS = RZAMSF(M02)
         LAMB2 = CELAMF(KW,M02,L2,R2,RZAMS,MENVD,lambda1)
