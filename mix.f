...
*       Specify case index for collision treatment.
      ...
      K2 = KS(I2)
      ICASE = KTYPE(K1,K2)
*     if(icase.gt.1000000) WRITE(66,*)' MIX ERROR ICASE>1000000 ',icase,k1,k2
*
...
*       Specify total mass.
      ...
      AGE3 = 0.d0
*
*       Restrict merged stars to masses less than 1000000 Msun. 
c      IF(M3.GE.1000000.D0)THEN
c         M3 = 99.D0
c         M03 = MIN(M03,M3)
c      ENDIF
*
